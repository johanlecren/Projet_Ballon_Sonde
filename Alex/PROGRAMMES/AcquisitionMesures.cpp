 ...
 * et la position
 */
void AcquisitionMesures::TraitementGps()
{
  if (hs->available())
  {
    char c = hs->read();
 ...
 * la température
 */
char* AcquisitionMesures::Temperature()
{
  return temperature;
}
 ...
 * l'humidite
 */
unsigned char AcquisitionMesures::Humidite()
{
  return humidite;
}
 ...
 * la pression
 */
unsigned short AcquisitionMesures::Pression()
{
  return pression;
}
 ...
 * l'altitude
 */
unsigned short AcquisitionMesures::Altitude()
{
  return altitude;
}
 ...
 */
unsigned char AcquisitionMesures::Minute()
{
  return minute;
}
 ...
 */
unsigned char AcquisitionMesures::Heure()
{
  return heure;
}
 ...
 */
unsigned char AcquisitionMesures::Jour()
{
  return jour;
}
 ...
 */
unsigned char AcquisitionMesures::Mois()
{
  return mois;
}
